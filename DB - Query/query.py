...
##links = [Link(0, 10, 1334014208.0, 100, 'Iago', 'http://hyalen.us'),
##         Link(1, 11, 1334014308.0, 100, 'Hyalen', 'http://hyalen.us'),
##         Link(2, 12, 1334014408.0, 100, 'Gabriela', 'http://hyalen.us'),
##         Link(3, 13, 1334014508.0, 100, 'Igor', 'http://hyalen.us'),
##         Link(4, 14, 1334014608.0, 100, 'Nicole', 'http://hyalen.us')]
##
##def query():
##    for link in links:
##        if link.id == 2:
...
def query_two():
    ...
    result.sort(key = lambda x: x.submitted_time)
    return result
...
new_link = Link(50, 48626, 1333934004.0, 17,
         "Hyalen Moreira",
         "http://www.r-bloggers.com/an-r-programmer-looks-at-julia/")
